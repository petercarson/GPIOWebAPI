...
namespace GPIOWebAPI
{
  internal static class HeatingArray
  {
    ...
    public static bool heatingEnabled = true;
    ...
    private static void OnTimedEvent(Object source, ElapsedEventArgs e)
    {
      if (heatingEnabled)
      {
        ...
        {
          // Master ensuite needs the boiler and floor heat pumps
          valueBoiler = 0;
        ...
        if (heatingArray[HeatingArray.BASEMENT_FLOOR].Enabled)
        {
          ...
          {
            // Basement floor needs the boiler and floor heat pumps
            valueBoiler = 0;
            valuePumpFloorHeat = 0;
        ...
        if (heatingArray[HeatingArray.KATE_BEDROOM].Enabled)
        {
          ...
          // Rads need the boiler and rad pumps
          valueBoiler = 0;
          valuePumpRads = 0;
        }
        ...
        if (heatingArray[HeatingArray.KATE_BATHROOM].Enabled)
        {
          ...
          // Floor needs the boiler and floor heat pumps
          valueBoiler = 0;
          valuePumpFloorHeat = 0;
        }
        ...
        GPIOArray.gpioArray[GPIOArray.BOILER].Value = valueBoiler;
